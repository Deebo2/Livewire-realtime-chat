<div class=" fixed  h-full flex bg-white dark:bg-gray-800  dark:border-gray-700 border lg:shadow-sm overflow-hidden inset-0 lg:top-16 lg:inset-x-2 m-auto lg:h-[90%]   rounded-lg" >
    <div class="    relative dark:border-gray-600 w-full h-full md:w-[320px] xl:w-[400px] border-0 shrink-0 overflow-y-auto  ">
        {{-- <livewire:chat.chat-list> --}}
           <livewire:chat.chat-list>
    </div>

    <main class="relative hidden w-full h-full overflow-y-auto border-l md:grid dark:border-gray-700"  style="contain:content">
        <div class="flex flex-col justify-center col-span-12 gap-3 m-auto text-center">
